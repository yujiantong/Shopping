...
<html>
  <head>
    ...
    <title>My JSP 'Ads_list.jsp' starting page</title>
 ...
 <!--列表样式-->
	...
	<tbody>
      ...
      <td class="td-manage">
        ...
        <a title="编辑" onclick="member_edit('编辑','admin/member-add.jsp','4','','510')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>      
