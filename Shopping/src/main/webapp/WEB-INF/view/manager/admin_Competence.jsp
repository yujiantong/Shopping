...
<html>
  <head>
    ...
    <title>My JSP 'admin_Competence.jsp' starting page</title>
...
<body>
 <div class="margin clearfix">
   <div class="border clearfix">
       <span class="l_f">
        <a href="admin/Competence.jsp" id="Competence_add" class="btn btn-warning" title="添加权限"><i class="fa fa-plus"></i> 添加权限</a>
...
function Competence_del(id){
		window.location.href ="admin/Competence.jsp?="+id;
};	
/*字数限制*/
