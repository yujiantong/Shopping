  ...
  <div class="sort_list">
	...
	<tbody>
      ...
      <td class="td-manage">
        ...
        <a href="admin/Ads_list.jsp" name="Ads_list.jsp" class="btn btn-xs btn-pink ads_link" onclick="AdlistOrders('561');" title="幻灯片广告列表"><i class="fa  fa-bars  bigger-120"></i></a>
       </td>
      </tr>
    </tbody>
    </table>
