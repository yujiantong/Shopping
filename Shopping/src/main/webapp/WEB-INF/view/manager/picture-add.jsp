...
<script type="text/javascript">
				   ...
				   function callback(){
				     if(xhr.readyState==4){
				       ...
				       if(str=="true"){
				         document.getElementById("nameMsge").innerHTML="该商品已经存在！";
				       }else{
				         document.getElementById("nameMsge").innerHTML="商品名称可用！";
				       }
				     }
				   }
				    function checkGoodName111(){
				   	  xhr=new XMLHttpRequest();
				   	  var name=document.myform.goodName.value;
				   	  xhr.onreadystatechange=callback;
				   	  xhr.open("post","checkGoodName.do?goodName="+name);
				   	  xhr.send(null);
				   }  
				</script>
</head>
<body>
	<div class="clearfix" id="add_picture">
		...
		<div class="page_right_style">
			<div class="type_title">商品详细信息</div>
			<form name="myform" action="${pageContext.request.contextPath}/goodsBack/saveGoods" method="post" class="form form-horizontal" enctype="multipart/form-data"
				id="form-article-add">
				<div class="clearfix cl">
					<label class="form-label col-2"><span class="c-red">*</span>商品名称：</label>
					<div class="formControls col-10">
						<input  type="text" id="gname"   class="input-text" value="" placeholder="请在此输入名称"
							 name="goodsName"  onblur="checkGoodName111()" />
				...
				<div class=" clearfix cl">
					...
					<div class="Add_p_s">
						...
						<div class="formControls col-2">
							<input type="text" class="input-text" value="" placeholder="请在此输入价格"
					...
					<div class="Add_p_s">
						...
						<div class="formControls col-2">
							<input type="text" class="input-text" value="" placeholder="请在此输入产地"
					...
					<div class="Add_p_s">
						...
						<div class="formControls col-2">
							<input type="text" class="input-text" value="" placeholder="请在此输入库存"
					...
					<div class="Add_p_s">
						...
						<div class="formControls col-2">
							<span class="select-box"> <select class="select" name="goodsType.typeId" id="gtypeid">
									<option>请选择类型:</option>
					...
					<div class="Add_p_s">
						...
						<div class="formControls col-2">
							<span class="select-box"> <select class="select" name="goodsState.statuId" id="gstatuid">
									<option value="">请选择类型:</option>
									<%-- <c:forEach items="${applicationScope.statusList}" var="goodStatu">
									   <option value="${goodStatu.statuId }">${goodStatu.statuName}</option>
									</c:forEach> --%>
				 ...
				 <div class="clearfix cl">
					...
					<div class="formControls col-10">
						<textarea name="goodDescription" id="ddescription" cols="" rows="" class="textarea"
...
<div class="img-box full">
	<section class=" img-section">
		<p class="up-p">商品图片：<span class="up-span">添加多张图片时，必须同时选取</span></p>
...
<aside class="mask works-mask">
	<div class="mask-content">
		...
		<p class="check-p"><span class="del-com wsdel-ok">确定</span><span class="wsdel-no">取消</span></p>
				...
				<div class="clearfix cl">
					...
					<a onclick="mysaveSubmit()" class="btn btn-primary radius" >
							<i class="icon-save "></i>保存并提交 </a>
	...
	<script type="text/javascript">
					function mysaveSubmit(){
					            var gname=$("#gname").val();
							    var gprice =$("#gprice").val();
							    var gaddress =$("#gaddress").val(); 
							    var gnum =$("#gnum").val(); 
							    var file =$("#file").val(); 
							    var gstatuid =$("#gstatuid").val(); 
							    var gtypeid = $("#gtypeid").val();
							    if(gname==""||gprice==""||gaddress==""||gnum==""||file==""||gstatuid==""||gtypeid==""){
							      layer.msg('您输入的信息不完整，请完善后提交！',{icon:2,time:2000});
							      }
							     else{ 
							      document.myform.action="${pageContext.request.contextPath}/goodsBack/saveGoods";
			...
			$(function() {
				...
				if (!WebUploader.Uploader.support('flash')
					...
					if (flashVersion) {
						...
						$wrap
								.jsp('<a href="http://www.adobe.com/go/getflashplayer" target="_blank" border="0"><img alt="get flash player" src="http://www.adobe.com/macromedia/style_guide/images/160x41_Get_Flash_Player.jpg" /></a>');
					}
