    ...
    <div class="side_title"><a title="隐藏" class="close_btn"><span></span></a></div>
     <div class="side_list">
      ...
      <div class="widget-body">
          ...
          <div style="font:楷体; font-size:16px;margin-left:15px;">
					商品类型列表
					    <ul style="font:楷体;font-size:13px;margin-left:30px;">
					       <li>母婴专区</li>
					       <li>美妆护肤</li>
					       <li>家居生活</li>
					       <li>食品营养</li>
...
<!---->
 <iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO  SRC="${pageContext.request.contextPath}/path/manager/product-category-add" class="page_right_style"></iframe>
 </div>
</div>
</body>
</html>
