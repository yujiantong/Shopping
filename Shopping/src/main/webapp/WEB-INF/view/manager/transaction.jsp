 ...
 <div class="transaction_style">
   <ul class="state-overview clearfix">
    <li class="Info">
     ...
     <span class="value"><h4>交易金额</h4><p class="Quantity color_red">${requestScope.successMoney }</p></span>
    </li>
     <li class="Info">
     <span class="symbol  blue"><i class="fa fa-shopping-cart"></i></span>
     <span class="value"><h4>订单数量</h4><p class="Quantity color_red">${requestScope.totalOrder}</p></span>
    </li>
     <li class="Info">
     <span class="symbol terques"><i class="fa fa-shopping-cart"></i></span>
     <span class="value"><h4>交易成功</h4><p class="Quantity color_red">${requestScope.successOrder }</p></span>
    </li>
     <li class="Info">
     <span class="symbol yellow"><i class="fa fa-shopping-cart"></i></span>
     <span class="value"><h4>交易失败</h4><p class="Quantity color_red">${requestScope.failOrder }</p></span>
    </li>
     <li class="Info">
     <span class="symbol darkblue"><i class="fa fa-jpy"></i></span>
     <span class="value"><h4>退款金额</h4><p class="Quantity color_red">${requestScope.backMoney }</p></span>
    </li>
   </ul>
