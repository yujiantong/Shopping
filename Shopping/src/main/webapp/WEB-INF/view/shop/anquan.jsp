...
<html>
  <head>
    ...
    <link href="css/anquan.css" type="text/css" rel="stylesheet"/>
    <!-- 右侧返回顶部 -->
...
<div class="wt1080 middle">
    <div class="fl">
        ...
        <ul>
            ...
            <li class="current"><a href="${pageContext.request.contextPath}/path/shop/anquan">账户安全</a></li>
    ...
    <div class="fr">
        <ul>
            <li>
                <span class="a lock">登陆密码</span>
                <span class="b">登陆洋店网账户时需要输入的密码</span>
                <span class="c"><a href="javascript:void(0)">重置</a></span>
            </li>
            <li>
                <span class="a">手机绑定</span>
                <span class="b">一个手机号仅限绑定一个洋店网帐号</span>
                <span class="c"><a href="javascript:void(0)">绑定</a></span>
            </li>
            <li>
                <span class="a">邮箱绑定</span>
                <span class="b">邮箱绑定后，以便于更多好的管理和查看账户信息</span>
                <span class="c"><a href="javascript:void(0)">重置</a></span>
            </li>
        </ul>
    </div>
