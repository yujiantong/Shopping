...
<script type="text/javascript"> 
		$(function() {
			...
			$('#keyword').autocomplete("${pageContext.request.contextPath}/LuceneController/searchKeyWord.action",{
				...
				location.href="${pageContext.request.contextPath }/LuceneController/searchGoodsNotPage.html?sname="+row;
			}); 
		});
	</script>
<!--------------logo搜索------------->
    ...
    <div class="search fl">
        <div>
        	<form action="${pageContext.request.contextPath }/LuceneController/searchGoods.html" method="post" autocomplete="off">
	            <input id="keyword" name="sname" type="text" class="a_search fl" value="${sessionScope.sname }" placeholder="请输入关键字">
...
<div class="content">
        ...
        <ul>
        	<c:forEach items="${requestScope.goodsList}" var="goods">
	            <li>
	                ...
	                <p class="one">
	                <a href="show.jsp">${goods.goodsName}</a>
	                </p>
	                <p class="two">
    ...
    <%-- <div class="page wt1080">
	    <a href="${pageContext.request.contextPath }/LuceneController/searchGoods.html?sname=${sessionScope.sname}&page=${requestScope.page-1}">上一页</a>
	    <c:forEach begin="1" end="${requestScope.countPage}" var="i">
	    	<c:if test="${i lt 6 }">
	    		<a href="${pageContext.request.contextPath }/LuceneController/searchGoods.html?sname=${sessionScope.sname}&page=${i}">${i }</a>
	    	</c:if>
	    	<c:if test="${i eq 6 }">
	    		<a href="javascript:void(0)">...</a>
	    	</c:if>
	    </c:forEach>
	    <!-- <a href="javascript:void(0)">1</a><a href="javascript:void(0)">2</a><a href="javascript:void(0)">3</a><a href="javascript:void(0)">4</a><a href="javascript:void(0)">5</a> -->
	    <a href="${pageContext.request.contextPath }/LuceneController/searchGoods.html?sname=${sessionScope.sname}&page=${requestScope.page+1}">下一页</a>
    </div> --%>
</div>
